...
const ExamForm: React.FC<ExamFormProps> = ({
  ...
  const handleGenerate = (values: any) => {
    ...
    const subjectQuestions = questions.filter(q => 
      ...
      (!knowledgeDomain || q.knowledgeDomain === knowledgeDomain)
    );
    ...
    const totalRequestedQuestions = 
      easyQuestions + mediumQuestions + hardQuestions + veryHardQuestions;
