...
const QuestionBank: React.FC = () => {
  ...
  useEffect(() => {
    const filtered = questions.filter(question => {
      const matchSubject = !searchFilters.subjectId ||
        question.subjectId === searchFilters.subjectId;
      const matchDifficulty = !searchFilters.difficulty ||
        question.difficulty === searchFilters.difficulty;
      const matchDomain = !searchFilters.knowledgeDomain ||
        question.knowledgeDomain === searchFilters.knowledgeDomain;
          ...
          <Button
            ...
            onClick={() => {
              Modal.info({
                ...
                content: (
                  <div>
                    <p><Text strong>Nội Dung:</Text> {record.content}</p>
                    <p><Text strong>Đáp Án:</Text> {record.answer || 'Chưa có đáp án'}</p>
                  </div>
                ),
                width: 600
              });
